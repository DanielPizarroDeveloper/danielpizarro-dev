export function NavPage() {
    return(
        <section style={{display: 'flex', position: 'fixed', width: '100%', top: '0px', flexDirection: 'row', justifyContent: 'center', gap: '50px', backgroundColor: 'black', height: '70px'}}>
                ...
                <ul style={{display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '50px'}}>
                    <li>
                        <button style={{display: 'flex', flexDirection: 'row', border: '0', backgroundColor: 'transparent', alignItems: 'center', gap: '10px'}}>
                            ...
                            <span style={{color: 'white', fontSize: 'medium'}}><a href="#header" style={{textDecoration: 'none', color: 'white'}}>DanielPizarroDev</a></span>
                        </button>
                    </li>
                    ...
                    <li style={{color: 'white', fontWeight: '300', listStyle: 'none'}}><a href="#" style={{textDecoration: 'none', color: 'white'}}><span>Proyectos</span></a></li>
